      ...
      <div className="row">
        <div className="col-lg-6 col-12 my-5">
          ...
          <p>
            ...
            create lifelong musical memories.With a commitment to quality and safety, Musical Toys ensures that every product we offer is not only entertaining but also designed to enhance cognitive skills and motor coordination. Our mission is to bring the magic of music into the lives of children, nurturing their love for the arts and fostering a lifelong appreciation for the wonders of sound.
          </p>
        </div>
        <div className="col-lg-6 col-12 my-4">
            <img src={aboutPic} alt="about us pic" className="img-fluid w-100 h-75" />
        </div>
      </div>
    </div>
  );
