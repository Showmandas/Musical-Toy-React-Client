...
export default function Gallery() {
  return (
    <div className='container my-5'>
        ...
        <div className="col-lg-4 col-12 text-center mb-5">
        <img src={gallery_2} alt="toy gallery pic" className='img-fluid w-75 h-100' />

        </div>
        <div className="col-lg-4 col-12 text-center mb-5">
        <img src={gallery_3} alt="toy gallery pic" className='img-fluid w-75 h-100' />
        ...
        <div className="col-lg-4 col-12 text-center mb-5">
        <img src={gallery_5} alt="toy gallery pic" className='img-fluid w-75 h-100' />
